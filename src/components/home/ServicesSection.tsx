  ...
  return (
    <section className="py-16 bg-white">
      <div className="container-custom">
        <h2 className="text-4xl font-bold text-center mb-8 text-[#183152]">Our Main Focus</h2>
        ...
        <div className="flex justify-center">
          <div className="grid md:grid-cols-3 gap-8 max-w-6xl">
            {services.map((service, index) => (
              ...
              >
                <div className="w-16 h-16 bg-[#B80002]/10 rounded-full flex items-center justify-center mb-4 text-[#B80002] mx-auto">
                  {service.icon}
                </div>
