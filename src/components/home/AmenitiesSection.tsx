  ...
  return (
    <section className="py-16 bg-gray-100">
      <div className="container-custom">
        <h2 className="text-3xl md:text-4xl font-bold text-center mb-4 text-[#183152]">Building Amenities</h2>
        ...
        <div className="grid grid-cols-2 md:grid-cols-4 gap-6">
          {amenities.map((amenity, index) => (
            ...
            >
              <div className="w-12 h-12 mx-auto bg-[#B80002]/10 rounded-full flex items-center justify-center mb-2 md:mb-4 text-[#B80002]">
                {amenity.icon}
              </div>
