...
import { Building2, Home, Search, Bed, Bath, Filter, ChevronLeft, ChevronRight } from 'lucide-react';
...
const RentProperties = () => {
  ...
  useEffect(() => {
    ...
    searchProperties({...filters, propertyType: 'rent'});
  }, []);
      ...
      <div className="flex-grow py-12">
        <div className="container-custom">
          <div className="flex flex-col items-center justify-center mb-12">
            ...
            <h1 className="text-4xl font-bold text-center mb-6">Properties For Rent</h1>
            <p className="text-lg text-gray-600 text-center max-w-2xl mb-8">
              Find your perfect rental property from our wide selection of homes, apartments, and condos.
            </p>
            ...
            <div className="w-full max-w-4xl bg-white rounded-lg shadow-lg p-6 mb-12">
              <form onSubmit={handleSearch}>
                <div className="flex flex-col md:flex-row gap-4 mb-4">
                  ...
                  <Button className="bg-secondary hover:bg-secondary/90" type="submit">
            ...
            {/* Loading state */}
            {loading ? (
              <Loader text="Loading rental properties..." />
            ) : (
              <>
                {/* Property count */}
                  ...
                  <div className="w-full max-w-6xl bg-white rounded-lg shadow p-8 text-center">
                    ...
                    <Button 
                      ...
                      onClick={() => {
                        ...
                        setTimeout(() => searchProperties({...filters, propertyType: 'rent', location: ''}), 100);
                      }}
                    >
                      Reset Filters
                    </Button>
                        ...
                        .map((property, index) => (
                          ...
                          >
                            ...
                            <div className="p-6">
                              ...
                              <p className="text-secondary font-bold text-xl mb-4">{property.price}</p>
                        ...
                        <div className="flex gap-1">
                          {Array.from({ length: totalPages }, (_, i) => i + 1).map((page) => (
                            <Button
                              ...
                              className={`w-10 h-10 p-0 ${currentPage === page ? 'bg-secondary text-white' : ''}`}
